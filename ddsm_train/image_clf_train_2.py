...
def step_decay_schedule(epoch, lr):
    ...
    drop_factor = 0.5  # drop the learning rate by this factor
    epochs_drop = 10  # drop the learning rate every these many epochs
    new_lr = initial_lr * (drop_factor ** np.floor((1+epoch)/epochs_drop))
    return new_lr
