...
res_mod = load_model('/home/c4ndypuff/Documentos/end2end-all-conv-master_copia/ddsm_train/inbreast_vgg16_512x1.h5', compile=False)
...
test_generator = test_imgen.flow_from_directory(
    ...
    classes=['neg', 'pos'], class_mode='categorical', batch_size=1, 
    shuffle=False)
